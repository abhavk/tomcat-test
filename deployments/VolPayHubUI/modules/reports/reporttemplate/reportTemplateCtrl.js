VolpayApp.controller('reportTemplateCtrl', function ($scope, $state, bankData, GlobalService, $timeout,$location,LogoutService) {
	var restServer = RESTCALL.ReportsTemplate + 'readall';
            	var delData = {};
            	$scope.backUp = {};
            	$scope.indexx = "";
            ...
            $scope.toggleWindow = function(val,Id,viewMe){
             ...
             $scope.setViewMe = function(viewMe)
               ...
               $scope.bankData.QueryOrder = [{"ColumnName":$scope.orderByField,"ColumnOrder":$scope.SortType}];
            	...
            	bankData.crudRequest("POST", restServer, {}).then(applyRestData,errorFunc);
            	...
            	$scope.deleteData = function() {
            		...
            		/*$scope.bankData.Data = btoa(JSON.stringify({
            			 "Records" : [{
            				...
            				},
            				{
            					...
            					"ColumnValue" : delData.ApplicableDate
            				},
            				{
            					"ColumnName" : "SourceCurrency",
            					"ColumnValue" : delData.SourceCurrency
            				},
            				{
            					"ColumnName" : "TargetCurrency",
            					"ColumnValue" : delData.TargetCurrency
            				}]
            		...
            		restServer = RESTCALL.ReportsTemplate+'delete';
            	...
            	function getData(response) {
            		...
            		//$scope.bankData.Data = btoa(JSON.stringify({'UserId' : sessionStorage.UserID, 'start' : 0, 'count' : 20, "QueryOrder":[{"ColumnName":$scope.orderByField,"ColumnOrder":$scope.SortType}]}));
            		restServer = RESTCALL.ReportsTemplate+'readall';
            		bankData.crudRequest("POST", restServer,$scope.bankData).then(applyRestData,errorFunc);
            	}
            	...
            	function errorFunc(errorMessag,status){
           ...
           $scope.viewData = function(data,flag)
           {
            ...
            $location.path('app/reporttemplatedetail')
           }
	...
	/** List and Grid view Ends**/
		...
		$scope.exportToExcel = function(eve){
			...
			bankData.exportToExcel(table_html, 'FX Rates')
		}
