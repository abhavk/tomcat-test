...
! function(a, b, c) {
    ...
    b.module("ngIdle", ["ngIdle.keepalive", "ngIdle.idle", "ngIdle.countdown", "ngIdle.title", "ngIdle.localStorage"]), b.module("ngIdle.keepalive", []).provider("Keepalive", function() {
        ...
        var d = this.idle = function(b) {
            b = sessionStorage.sessionTimeLimit*60;
            //console.log("b",b)
            if (0 >= b) throw new Error("Idle must be a value in seconds, greater than 0.");
            //a.idle = b
            a.idle = sessionStorage.sessionTimeLimit*60;
        };
        this.autoResume = function(b) {
            ...
            function n() {
                t.idling = !t.idling;
                var b = t.idling ? "Start" : "End";
                g.$broadcast("Idle" + b), t.idling ? (m(), a.timeout && (t.countdown = a.timeout, o(), t.timeout = e(o, 1e3, a.timeout, !1))) : l(), e.cancel(t.idle)
            }

            function o() {
                return t.countdown <= 0 ? void p() : (g.$broadcast("IdleWarn", t.countdown), void t.countdown--)
            }
            ...
            var t = {
                ...
                v = {
                   ...
                   // console.log(a.idle)
                       // return a.idle
                        return sessionStorage.sessionTimeLimit;
                    },
                    getTimeout: function() {
                        return a.timeout
                    },
                    ...
                    watch: function(b) {
                       ...
                       // b || s(new Date((new Date).getTime() + 1e3 * (a.idle + c))), t.idling ? n() : t.running || l(), t.running = !0, t.idle = e(n, 1e3 * a.idle, 0, !1)
                        b || s(new Date((new Date).getTime() + 1e3 * ((sessionStorage.sessionTimeLimit*60) + c))), t.idling ? n() : t.running || l(), t.running = !0, t.idle = e(n, 1e3 * sessionStorage.sessionTimeLimit*60, 0, !1)
                       // console.log(a.idle)
                    ...
                    interrupt: function(b) {
                         ...
                         return t.running ? a.timeout && this.isExpired() ? void p() : void(("idle" === a.autoResume || "notIdle" === a.autoResume && !t.idling) && this.watch(b)) : void 0
                    }
                };
            h.find("html").on(a.interrupt, function(a) {
                "mousemove" === a.type && a.originalEvent && 0 === a.originalEvent.movementX && 0 === a.originalEvent.movementY || ("mousemove" !== a.type || b.isUndefined(a.movementX) || a.movementX || a.movementY) && v.interrupt()
            });
            var w = function(a) {
            ...
            return k.addEventListener ? k.addEventListener("storage", w, !1) : k.attachEvent("onstorage", w), v
        }]
